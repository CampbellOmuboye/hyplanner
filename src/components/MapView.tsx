...
import { MOCK_REGIONS } from "@/lib/mockRegions";
import { getRegionCenter } from "@/lib/mockRegions";
import {
  PORTS,
  HYDROGEN_PIPELINES,
  POWER_GRID_POINTS,
...
import { NETHERLANDS_CENTER, NETHERLANDS_DEFAULT_ZOOM } from "@/lib/constants";
  ...
  return (
    <>
      {MOCK_REGIONS.map((region) => {
        const raw =
          (currentLensId && region.classificationByLens?.[currentLensId]) ??
          region.classification;
        const classification: OpportunityClassification =
          raw === "Viable" || raw === "Investable" ? raw : fallbackClassification;
