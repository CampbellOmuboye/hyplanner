...
export const MOCK_REGIONS: Region[] = [
  ...
  },
  {
    ...
    opportunityDrivers: [
      ...
      "Strategic location for H2 corridors",
    ],
    developmentGaps: [
  ...
  },
  {
    ...
    opportunityDrivers: [
      "Proximity to offshore wind",
      "Diverse demand potential",
    ],
    developmentGaps: [
      "Scale of production projects to be confirmed",
      "Grid capacity for new demand",
    ],
    geometry: polygon([
      [4.7, 52.5],
      [5.25, 52.55],
